...
- 2024 (FJUEL conference, Bamberg) *Dynamic documents in R: Introduction to Quarto* \| [slides session 1](docs/resources_pages/slides_fjuel_session_1.html){target="_blank"}
