...
- 2023 (University of Würzburg) *Basics of data analysis using R and RStudio* `r icons::academicons$osf` [OSF](https://osf.io/j43v9/) | [slides part 2](resources_pages/slides_part_2.html){target="_blank"} | [slides part 3](resources_pages/slides_part_3.html){target="_blank"} 
- 2022 (University of Würzburg) *Basic statistical methods for TEFL research* `r icons::academicons$osf` [OSF](https://osf.io/v37pw/) 
- 2019 (FJUEL conference, Bayreuth): *Using "statistics" to learn about language: What matters (and what doesn‘t)* `r icons::academicons$osf` [OSF](https://osf.io/jafbz/)
- 2019 (BICLCE conference, Bamberg): *The replication crisis in science: Challenges and chances for linguistics* `r icons::academicons$osf` [OSF](https://osf.io/dhbce/)
